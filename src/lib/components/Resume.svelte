...
<svg
    ...
    fill="currentColor"
    class="bi bi-file-earmark-person-fill fill-black dark:fill-brown-100 hover:fill-gray-600 {width}"
    viewBox="0 0 16 16"
>
    <title id="svgTitle">resume</title>
    <desc id="svgDescription">resume icon</desc>
    <path
